...
// GetAllCommissions mocks base method.
func (m *MockSettlementRepository) GetAllCommissions(ctx context.Context) ([]domain.CommissionLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCommissions", ctx)
	ret0, _ := ret[0].([]domain.CommissionLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllCommissions indicates an expected call of GetAllCommissions.
func (mr *MockSettlementRepositoryMockRecorder) GetAllCommissions(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCommissions", reflect.TypeOf((*MockSettlementRepository)(nil).GetAllCommissions), ctx)
}
