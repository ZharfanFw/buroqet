  ...
  return (
    <div className="bg-white shadow-2xl rounded-3xl overflow-hidden border border-[#e4ece3]">
      ...
      <div className="flex border-b border-[#e4ece3]">
        ...
        <Link to="/customer/register" className="flex-1 text-center py-5 text-slate-500 hover:text-slate-700 hover:bg-slate-50 transition-colors font-bold">
          Sign Up
        </Link>
      </div>
      ...
      <div className="p-8 md:p-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-2">Masuk ke akun Buroqet Anda</p>
        </div>
