...
const navItems = [
  { path: '/courier/dashboard', label: 'Dashboard', icon: '🛵' },
  { path: '/courier/assignment', label: 'Pickup/Delivery', icon: '📋' },
  { path: '/courier/epod', label: 'Upload ePOD', icon: '📸' },
  { path: '/courier/history', label: 'Riwayat Pengiriman', icon: '🛣️' },
  { path: '/courier/profile', label: 'Profil', icon: '👤' },
];
    ...
    <div className="flex h-screen bg-[#f7faf7] overflow-hidden">
      ...
      <aside className="w-72 bg-white border-r border-[#e4ece3] flex flex-col shadow-sm">
        <div className="h-20 flex items-center px-8 border-b border-[#e4ece3]">
          ...
          <span className="text-2xl font-extrabold text-slate-800 tracking-tight">Buroqet <span className="text-[#64965a] text-sm font-bold ml-1 bg-[#64965a]/10 px-2 py-1 rounded-lg">FLEET</span></span>
        </div>

        <div className="p-6 pb-2">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Courier Tools</p>
        </div>
        ...
        <div className="p-6 border-t border-[#e4ece3] bg-slate-50/50">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-xs text-slate-500 font-medium truncate">Fleet Agent</p>
            </div>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-[#e4ece3] flex items-center justify-between px-10 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-extrabold text-slate-800">Fleet Operations</h1>
            <div className="hidden md:flex items-center gap-2 text-sm text-slate-400 font-medium">
              <span>/</span>
              <span className="text-[#64965a]">Agent Dashboard</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-8">
            <div className="relative hidden md:block">
              ...
              <input type="text" placeholder="Search tasks..." className="py-2.5 pl-11 pr-4 bg-slate-50 border border-[#e4ece3] rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#64965a] focus:border-[#64965a] transition-shadow w-64" />
            </div>

            <div className="flex items-center gap-2 px-4 py-2 bg-green-50 rounded-xl text-xs text-[#64965a] font-bold border border-green-100">
